...
type Module = typeof import("../api.mobile.roadmap.$roadmapId.js")

type Info = GetInfo<{
  file: "routes/api.mobile.roadmap.$roadmapId.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.mobile.roadmap.$roadmapId.js");
}];
